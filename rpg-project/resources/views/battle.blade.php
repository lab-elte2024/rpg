...
<body>
    ...
    <div class="parent">
        ...
        <div class="div3" onclick="useSkill({{ $skill1->damage }},{{ $skill1->is_healing }})">{{ $skill1->name }}
        </div>
        <div class="div4" onclick="useSkill({{ $skill2->damage }},{{ $skill2->is_healing }})">{{ $skill2->name }}
        </div>
        <div class="div5" onclick="useSkill({{ $skill3->damage }},{{ $skill3->is_healing }})">{{ $skill3->name }}
        </div>
